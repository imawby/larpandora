/**
 *  @file   larpandora/TestValidationAlgorithm.cxx
 *
...
void TestValidationAlgorithm::FillValidationInfo(const MCParticleList *const pMCParticleList, const CaloHitList *const pCaloHitList,
...
void TestValidationAlgorithm::ProcessOutput(const ValidationInfo &validationInfo, const bool useInterpretedMatching, const bool printToScreen, const bool fillTree) const
{
...
StatusCode TestValidationAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
{
