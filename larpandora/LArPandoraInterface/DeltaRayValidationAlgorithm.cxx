/**
 *  @file   larpandorA/LArPandoraInterface/DeltaRayValidationAlgorithm.cc
 *
 *  @brief  Implementation of the delta ray validation 
 *
 *  $Log: $
 */
...
DeltaRayValidationAlgorithm::DeltaRayValidationAlgorithm() :
...
void DeltaRayValidationAlgorithm::FillValidationInfo(const MCParticleList *const pMCParticleList, const CaloHitList *const pCaloHitList,
...
void DeltaRayValidationAlgorithm::FillDeltaRayValidationInfo(const MCParticleList *const pMCParticleList, const CaloHitList *const pCaloHitList,
    const PfoList *const pPfoList, ValidationInfo &validationInfo) const
{
...
void DeltaRayValidationAlgorithm::DetermineIncorrectlyReconstructedMuons(const MCParticleList *const pMCParticleList, const CaloHitList *const pCaloHitList,
...
StatusCode DeltaRayValidationAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
{
...
void DeltaRayValidationAlgorithm::GetRecoMuonHits(const MCParticleList *const pMCParticleList, const CaloHitList *const pCaloHitList,
...
void DeltaRayValidationAlgorithm::FillContaminationHitsDistance(const CaloHitList &contaminationHits, const CaloHitList &leadingMCHits,
...
void DeltaRayValidationAlgorithm::GetHitsOfType(const CaloHitList &inputList, const HitType &hitType, CaloHitList &outputList) const
{
